...
page 50096 "Payment Voucher"
{
            ...
            group("&Functions")
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        Rec.modify;
                        Message('This record has been approved.');
                ...
                action(Approval)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(51516112, DocumentType, rEC."No.");
                        ApprovalEntries.RUN;
                    end;
                }
    ...
    begin
        ...
        Rec."Global Dimension 1 Code" := 'INVESTMENT';
    ...
    begin
        ...
        //Temp.GET(USERID);//Kitui check this Bug
        ...
        IF PayLine.FIND('-') THEN BEGIN
            ...
            REPEAT
                ...
                IF PayLine."Account Type" = PayLine."Account Type"::Customer THEN BEGIN
                    ...
                    GenJnlLine."Plot Number" := PayLine."Plot Number";
                    GenJnlLine."Plot Sale Document No" := PayLine."Plot Sale Document No";
                    GenJnlLine."Project Name" := PayLine."Project Name";
                END ELSE
                    // GenJnlLine."Document Type" := GenJnlLine."Document Type"::Payment;

                    GenJnlLine."Account Type" := PayLine."Account Type";
                GenJnlLine.Validate("Account Type");
                //Message('ONDI%1', GenJnlLine."Account Type");
            ...
            END;
            //EXIT;
            //Message('%1|%2', PayLine."Account Type", PayLine."Account No.");
