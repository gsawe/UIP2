...
Table 51512044 "Jobs"
{
    ...
    fields
    {
        ...
        field(51510001; "Approval Status"; Option)
        {
            Editable = true;
            OptionCaption = 'Open,Pending Approval,Approved';
            OptionMembers = Open,"Pending Approval",Approved;
        }
        field(51510002; "Responsibility Center"; Code[10])
        {
            // TableRelation = "Responsibility Center BR";
        }
        field(51510003; "Total Cost"; Decimal)
        {
            CalcFormula = sum("Job-Planning Line"."Total Cost" where("Grant No." = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(51510004; "Total Cost(LCY)"; Decimal)
        {
            CalcFormula = sum("Job-Planning Line"."Total Cost (LCY)" where("Grant No." = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(51512005; "Contract Description"; Text[150])
        {
        }
        field(51512006; "Contract Type"; Code[10])
        {
        ...
        field(51512008; "Allow OverExpenditure"; Boolean)
        {
        }
        field(51512009; "Accounted Amount"; Decimal)
        {
            Editable = false;
            FieldClass = FlowField;
        }
        field(51512010; "Received Amount"; Decimal)
        {
            FieldClass = FlowField;
        }
        field(51512011; "Proposal No"; Code[20])
        {
            Editable = false;
            TableRelation = Jobs."No." where("No." = field("Proposal No"),
                                              Status = const(Proposal));
        }
        field(51512012; "Converted To Proposal"; Boolean)
        {
            Editable = false;
        }
        field(51512013; "Project No"; Code[20])
        {
            Editable = true;
            TableRelation = Jobs."No." where("No." = field("Project No"),
                                              Status = const(Contract));
        }
        field(51512014; "Converted To Project"; Boolean)
        {
            Editable = true;
        }
        field(51512015; "Concept Number"; Code[20])
        {
        }
        field(51512016; Objective; Text[150])
        {
        }
        field(51512017; "Contract No"; Code[20])
        {
        }
        field(51512018; "Reporting dates generated"; Boolean)
        {
            Editable = false;
            FieldClass = FlowField;
        }
        field(51512019; "Condition for budget realloca"; Code[10])
        {
        }
        ...
        field(51512024; "Income Account"; Code[10])
        {
        }
        ...
        field(51512026; "Project Filter"; Code[10])
        {
            FieldClass = Normal;
        }
        ...
        field(51512030; "Project Status"; Option)
        {
            OptionCaption = 'Setup,In Progress,Halted,Completed';
            OptionMembers = Setup,"In Progress",Halted,Completed;
        }
        field(51512031; "Audit Indicator"; Boolean)
        {
        }
        field(172032; "Approved Funding Start Date"; Date)
        {
        }
        field(51512033; "Approved Funding End Date"; Date)
        {
        }
        field(51512034; "Justification Narration"; Text[200])
        {
            Description = 'Narrations defined esp. when modifying  the project/contract info';
        }
        field(51512035; "Amount Invoiced"; Decimal)
        {
            FieldClass = FlowField;
        }
        field(51512036; "Grant Level"; Option)
        {
        ...
        field(51512038; "Alert sent"; Boolean)
        {
        }
        field(51512039; "Proposal Application due Date"; Date)
        {
        }
        field(51512040; Submission; Option)
        {
            OptionCaption = ' ,Paper Submission,Electronic Submission';
            OptionMembers = " ","Paper Submission","Electronic Submission";
        }
        field(51512041; "PI Name"; Text[100])
        {
        ...
        field(51512042; "PI Address"; Text[30])
        {
        }
        field(51512043; "PI Telephone"; Text[30])
        {
        }
        field(51512044; "PI EMail"; Text[30])
        {
            ExtendedDatatype = EMail;
        }
        field(51512045; "Collaborative Grant"; Boolean)
        {
        }
        field(51512046; "IREC Approval"; Option)
        {
            OptionCaption = 'Pending Approval,Approved,Exempt';
            OptionMembers = "Pending Approval",Approved,Exempt;
        }
        field(51512047; "IREC Approval Date"; Date)
        {
        }
        field(51512048; "Cost Share"; Boolean)
        {
        }
        field(51512049; "Cost Share Details"; Text[100])
        {
        }
        field(51512050; Matching; Boolean)
        {
        }
        field(51512051; "Matching Details"; Text[150])
        {
        }
        field(51512052; "Application disposition Status"; Option)
        {
        ...
        field(51512053; "SubAward No."; Code[20])
        {
            Description = 'Project Sub award';
        }
        field(515102054; "Payment Methods"; Code[20])
        {
            TableRelation = "Payment Method".Code;
        }
        field(51512055; Schools; Code[10])
        {
            Caption = 'Kind of Program';
        }
        field(51512056; "Application Due Date"; Date)
        {
        }
        field(51512057; "Funding Request"; Boolean)
        {
        }
        field(51512058; Budget; Boolean)
        {
        }
        field(51512059; "Budget Justification"; Boolean)
        {
        }
        field(51512060; "Project Summary Abstract"; Boolean)
        {
        }
        field(51512061; "RSPO Completion List"; Boolean)
        {
        }
        field(51512062; Donors; Boolean)
        {
            FieldClass = FlowField;
        }
        field(51512063; Workplan; Boolean)
        {
            FieldClass = FlowField;
        }
