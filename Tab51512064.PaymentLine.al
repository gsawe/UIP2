...
Table 172064 "Payment Line."
{
    ...
    fields
    {
        ...
        field(101; "Job-Planning Line No"; Integer)
        {
            ...
            //                                          Field515102008 = field("Account No."));
        }
        ...
        field(5151000; "Property Code"; Code[30])
        {
            //TableRelation = Table56123.Field1;
        }
        field(515102001; "Transaction Code"; Code[30])
        {
            //TableRelation = Table56120.Field1;
        }
        field(515102002; "Entry Type[Income/Expense]"; Option)
        {
            OptionCaption = ' ,Income,Expense';
            OptionMembers = " ",Income,Expense;
        }
        field(515102003; "Asset No"; Code[10])
        {
