...
Table 51512335 "prPeriod Transactions."
{
    ...
    fields
    {
        ...
        field(27; "coop parameters"; Option)
        {
            ...
            OptionMembers = "none",shares,loan,"loan Interest","Emergency loan","Emergency loan Interest","School Fees loan","School Fees loan Interest",Welfare,Pension,NSSF,Overtime,DevShare,NHIF,Holiday;
        }
