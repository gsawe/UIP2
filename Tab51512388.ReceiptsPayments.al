...
Table 51512388 "Receipts & Payments"
{
    ...
    fields
    {
        ...
        field(5151000; Insuarance; Decimal)
        {
            FieldClass = Normal;
        }
        field(515102001; "Un allocated Amount"; Decimal)
        {
            Editable = false;
            FieldClass = Normal;
        }
        field(515102002; Source; Option)
        {

            OptionCaption = 'INVESTMENT,FOSA,MICRO';
            OptionMembers = BOSA,FOSA,MICRO;
            InitValue = BOSA;
            Editable = false;

        }
        field(515102003; "Receipt Mode"; Option)
        {
        ...
        field(515102004; Remarks; Text[50])
        {
        }
        field(515102005; "Code"; Code[20])
        {
        }
        field(515102006; Type; Option)
        {
            NotBlank = true;
            OptionMembers = " ",Receipt,Payment,Imprest,Advance;
        }
        field(51510007; Description; Text[50])
        {
        }
        field(515102008; "Default Grouping"; Code[20])
        {
            Editable = false;
        }
        field(515102009; "Transation Remarks"; Text[50])
        {
        }
        field(515102010; "Customer Payment On Account"; Boolean)
        {
        }
        field(515102011; "G/L Account"; Code[20])
        {
        ...
        field(515102012; Blocked; Boolean)
        {
        }
        field(515102013; "Global Dimension 1 Code"; Code[50])
        {
            CaptionClass = '1,1,1';
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(1),
                                                          "Dimension Value Type" = const(Standard));
        }
        field(515102014; "Global Dimension 2 Code"; Code[50])
        {
            CaptionClass = '1,2,2';
            Editable = false;
        ...
        field(515102015; "Excess Transaction Type"; Option)
        {
