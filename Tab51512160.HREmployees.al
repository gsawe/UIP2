...
Table 51512160 "HR Employees"
{
    ...
    fields
    {
        ...
        field(515102002; "Bosa Member account"; Code[20])
        {
            TableRelation = "Members Register";
        }
        field(515102003; "Sacco Paying Bank Code"; Code[20])
        {
        ...
        field(515102004; "Sacco Paying Bank Name"; Text[30])
        {
        }
        field(515102005; "Cheque No"; Code[20])
        {
