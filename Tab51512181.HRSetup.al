...
Table 51512181 "HR Setup"
{
    ...
    fields
    {
        ...
        field(5151000; "Loan Application Nos."; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102001; "Leave Carry Over App Nos."; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102002; "Pay-change No."; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102003; "Max Appraisal Rating"; Decimal)
        {
        }
        field(515102004; "Medical Claims Nos"; Code[10])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102005; "Employee Transfer Nos."; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102006; "Leave Planner Nos."; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(51510007; "Deployed Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102008; "Full Time Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102009; "Board Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102010; "Committee Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(515102011; "HR Insurance Sch Nos"; code[20])
        {
