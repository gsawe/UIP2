...
Table 51512050 "Imprest Header"
{
    ...
    fields
    {
        ...
        field(5151000; Requisition; Code[20])
        {
            TableRelation = "Purchase Header"."No.";
        }
        field(515102001; "Paying Account Type"; Option)
        {
            OptionCaption = 'FOSA Account,Bank Account';
            OptionMembers = "FOSA Account","Bank Account";
        }
        field(515102003; "Pending Imprest Amount"; Decimal)
        {
