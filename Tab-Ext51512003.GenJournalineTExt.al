//************************************************************************
tableextension 51510003 "GenJournalineTExt" extends "Gen. Journal Line"
{
    fields
    {
        ...
        {
            TableRelation = "Plots Register"."Plot No" where("Client Code" = field("Account No."));
        }
        ...
        field(51516441; "Account No"; Code[20])
        {
        ...
        Field(51516446; "Plot Number"; Integer)
        {
            DataClassification = ToBeClassified;
            TableRelation = Plots."Plot No" where(Project = field("Project Name"));

        }
        field(51516447; "Project Name"; Code[80])
        {
            DataClassification = ToBeClassified;
        ...
        field(51516448; "Plot Sale Document No"; Code[80])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Plots Register".No where("Client Code" = field("Account No."));

            trigger OnValidate()
            var
                PlotsSold: Record "Plots Register";
            begin
                PlotsSold.Reset();
                PlotsSold.SetRange(PlotsSold.No, Rec."Plot Sale Document No");
                if PlotsSold.FindFirst() then begin
                    Rec."Project Name" := PlotsSold.Project;
                    Rec."Plot Number" := PlotsSold."Plot No";
                end;
            end;
        }
