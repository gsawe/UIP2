...
Codeunit 5151000 "Funds Management"
{
    ...
    begin
        ...
        GenJnlLine."Bal. Account No." := '';
        GenJnlLine.Validate(GenJnlLine."Bal. Account No.");
        GenJnlLine."Shortcut Dimension 1 Code" := 'INVESTMENT';//ReceiptHeader."Global Dimension 1 Code";
        GenJnlLine.Validate(GenJnlLine."Shortcut Dimension 1 Code");
        GenJnlLine."Shortcut Dimension 2 Code" := 'NAIROBI'; //ReceiptHeader."Global Dimension 2 Code";
        GenJnlLine.Validate(GenJnlLine."Shortcut Dimension 2 Code");
    ...
    */
    ...
    var
        GenJnlLine: Record "Gen. Journal Line";
        LineNo: Integer;
        FundsLine: Record "Funds Transfer Lines";
