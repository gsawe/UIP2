table 51513001 "AU Access Control"
{
    ...
    fields
    {
        field(1; "User Security ID"; Guid)
        {
            ...
            TableRelation = "SURESTEP User"."User Security ID";
        }
        ...
        {
            CalcFormula = Lookup("SURESTEP User"."User Name" WHERE("User Security ID" = FIELD("User Security ID")));
            Caption = 'User Name';
