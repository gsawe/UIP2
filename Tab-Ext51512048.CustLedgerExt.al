//************************************************************************
tableextension 51512048 "CustLedgerExt" extends "Cust. Ledger Entry"
{
    ...
    fields
    {
        ...
        field(51516069; "Plot Number"; Integer)
        {
            DataClassification = ToBeClassified;
            TableRelation = Plots;
        }
        field(51516070; "Project Name"; Code[80])
        {
            DataClassification = ToBeClassified;
            TableRelation = Projects;
        }

        field(51516071; "Plot Sale Document No"; Code[80])
        {
            DataClassification = ToBeClassified;
        }
    }
