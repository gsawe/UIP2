...
Table 51512318 "Payroll Transaction Code."
{
    //nownPage51516323;
    //nownPage51516323;
    ...
    fields
    {
        ...
        {
            OptionCaption = 'None,Shares,Loan,Loan Interest,Emergency Loan,Emergency Loan Interest,School Fees Loan,School Fees Loan Interest,Welfare,Pension,NSSF,Overtime,Holiday';
            OptionMembers = "None",Shares,Loan,"Loan Interest","Emergency Loan","Emergency Loan Interest","School Fees Loan","School Fees Loan Interest",Welfare,Pension,NSSF,Overtime,Holiday;
        }
        ...
        field(53; "Is Pension?"; Boolean)
        {
        }
        field(54; "Pension Percentage"; Decimal)
        {
        }
    }
