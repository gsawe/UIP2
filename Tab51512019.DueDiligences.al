table 51512019 "Due Diligences"
{
    ...
    fields
    {
        ...
        field(10; "Project Name"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(19; "Cost Per Acre"; Decimal)
        {
            ...
            begin
                ...
                end else if Rec."Parcel Type" = Rec."Parcel Type"::"Land Mass" then begin
    ...
    keys
    {
        key(Key1; No, "Title No", "Project Name")
        {
            Clustered = true;
        }
    }
