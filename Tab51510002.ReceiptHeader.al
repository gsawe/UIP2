...
Table 51510002 "Receipt Header"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Receipt Lines".Amount where("Document No" = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(30; "Total Amount(LCY)"; Decimal)
        {
            CalcFormula = sum("Receipt Lines"."Amount(LCY)" where("Document No" = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
