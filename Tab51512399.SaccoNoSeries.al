...
Table 51512399 "Sacco No. Series"
{
    ...
    fields
    {
        ...
        field(51516084; "Plots Purchase"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }

        field(51516085; "Plots Receivable"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account";
        }

        field(51516086; "Diligence Nos"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }

        field(51516087; "Process Nos"; code[40])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(51516088; "Title Nos"; code[40])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }

        field(51516089; "Employer Nos"; code[40])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }

        field(51516090; "Plots Release"; code[40])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
