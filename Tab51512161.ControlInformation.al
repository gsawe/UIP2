...
Table 51512161 "Control-Information"
{
    ...
    fields
    {
        ...
        field(5151000; "Company P.I.N"; Code[30])
        {
        }
        field(515102001; "N.S.S.F No."; Code[30])
        {
        }
        field(515102002; "Company code"; Code[10])
        {
        }
        field(515102003; "Working Days Per Year"; Integer)
        {
        }
        field(515102004; "Working Hours Per Week"; Integer)
        {
        }
        field(515102005; "Working Hours Per Day"; Integer)
        {
        }
        field(515102006; Mission; Text[250])
        {
        }
        field(51510007; "Mission/Vision Link"; Text[50])
        {
        }
        field(515102008; Vision; Text[250])
        {
        }
        field(515102009; "N.H.I.F No"; Text[100])
        {
        }
        field(515102010; "Payslip Message"; Text[250])
        {
            Description = 'Dennis Added';
        }
        field(515102011; "Multiple Payroll"; Boolean)
        {
        }
        field(515102012; "Picture USAID"; Blob)
        {
            SubType = Bitmap;
        }
        field(515102013; "Board Tax Percent"; Decimal)
        {
        }
        field(515102014; "Committee Tax Per"; Decimal)
        {
        }
    }
