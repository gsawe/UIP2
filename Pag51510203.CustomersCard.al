page 51510203 "Customers Card"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Xmas Contribution"; Rec."Xmas Contribution")
                {
                    ...
                    ApplicationArea = All;
                    Importance = Promoted;
                    ToolTip = 'Specifies the outstanding balance.';
                    Visible = true;
                }
            ...
            group("Address /Contact & Bank Details")
            {
    ...
    actions
    {
        area(navigation)
        {
            ...
            {
                Caption = 'Dataverse';
                //Enabled = (Rec.BlockedFilterApplied and (Rec.Blocked = Blocked::" ")) or not BlockedFilterApplied;
        ...
        area(reporting)
        {
            ...
            action("Report Member Account Statement(Ver1)")
            {
                ApplicationArea = Basic, Suite;
                ...
                //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                //PromotedCategory = Category9;
                ToolTip = 'View a members statement.';

                trigger OnAction()
                begin
                    RunReport(REPORT::"Member Account Statement(Ver1)", Rec."No.");
                end;
            }
