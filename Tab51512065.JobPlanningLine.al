...
Table 172065 "Job-Planning Line"
{
    ...
    fields
    {
        ...
        field(515102002; "Income Account"; Code[20])
        {
            TableRelation = if (Type = const(Resource)) Resource else
            if (Type = const(Item)) Item else
        ...
        field(515102003; "Description 3"; Text[50])
        {
        }
        field(515102004; "Audit Provision"; Code[30])
        {
            // TableRelation = "Audit provision";
        }
        field(515102005; "Special Condition for Travel"; Code[30])
        {
            // TableRelation = "Special Conditions for Travel";
        }
        field(515102006; "Pending donor Issues"; Code[10])
        {
            // TableRelation = "Pending Donor Issues";
        }
        field(51510007; "Disbursment Due dates"; Date)
        {
        }
        field(515102008; Partner; Code[20])
        {
            // TableRelation = "Project Partners".PartnerID where("Grant No" = field("Grant No."));
        }
        field(515102009; "Budget Period"; Code[10])
        {
            // TableRelation = "Grant Phases";
        }
        field(515102010; "Total Year 1"; Decimal)
        {
        ...
        field(515102011; "Total Year 2"; Decimal)
        {
        ...
        field(515102012; "Total Year 3"; Decimal)
        {
        ...
        field(515102013; "Transfered To Budget"; Boolean)
        {
        }
        field(515102014; "Budget Grouping Code"; Code[30])
        {
            //   TableRelation = "Budget Grouping Codes";
        }
        field(515102015; "ICIPE Contribution"; Decimal)
        {
        }
        field(515102017; "Unaccounted Amount"; Decimal)
        {
        }
        field(515102018; "Disbursed Amount"; Decimal)
        {
        ...
        field(515102019; Restriction; Option)
        {
            OptionCaption = ' ,Restricted,Unrestricted';
            OptionMembers = " ",Restricted,Unrestricted;
        }
        field(515102020; "Donor Expense Code"; Code[10])
        {
        ...
        field(515102021; "Total Year 4"; Decimal)
        {
        ...
        field(515102022; "Total Year 5"; Decimal)
        {
        ...
        field(515102023; "Total Year 6"; Decimal)
        {
        ...
        field(515102024; "Budget in use"; Boolean)
        {
        }
    }
