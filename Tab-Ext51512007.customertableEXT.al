//************************************************************************
tableextension 51510007 "customertableEXT" extends Customer
{
    fields
    {
        ...
        field(68003; "Current Shares"; Decimal)
        {
            ...
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."), "Transaction Type" = filter("Deposit Contribution")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            TableRelation = "Investment Employers";
        ...
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."), "Transaction Type" = filter("Share Capital")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."), "Transaction Type" = filter(Plot | "Plot Repayment"), Reversed = filter(false)));
        ...
        field(5151000; "Old Account No"; Integer)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(515102001; "Old Accounts No"; Code[50])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }

        field(515102002; "ID NO"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(515102003; "KRA PIN"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(515102004; Marketer; Code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = "User Setup"."User ID";
        }
        field(515102005; "User Sales Manager"; Code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = "User Setup"."User ID";
        }
        field(515102006; "User Branch Manager"; Code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = "User Setup"."User ID";
        }

        field(51510007; "Member Type"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(515102008; "Sacco no"; CODE[40])
        {
            DataClassification = ToBeClassified;
        }

        field(515102009; "Employee Id"; CODE[40])
        {
            DataClassification = ToBeClassified;
        }
    ...
    var
        ...
        NoSeriesMgts: Codeunit NoSeriesManagement;
