...
Table 51512364 "Members Register"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = - sum("Detailed Cust. Ledg. Entry".Amount where("Customer No." = field("No."),
                                                                  "Transaction Type" = filter("Plot Repayment" | Plot),
                                                                  "Posting Date" = field("Date Filter"),
        ...
        field(69218; "Individual Category"; Text[40])
        {
            ...
            //where(Category = filter(Individuals));
            //This property is currently not supported
            //TestTableRelation = false;
            //
        }
        field(69219; Entities; Text[35])
        {
            ...
            //where(Category = filter(Entities));
            //This property is currently not supported
            //TestTableRelation = false;
            //
        }
        field(69220; "Industry Type"; Text[40])
        {
            ...
            //where(Category = filter(Industry));
            //This property is currently not supported
            //TestTableRelation = false;
            //
        }
        field(69221; "Length Of Relationship"; Text[35])
        {
            ...
            //where(Category = filter("Length Of Relationship"));
            //This property is currently not supported
            //TestTableRelation = false;
            //
        }
        field(69222; "International Trade"; Text[35])
        {
            ...
            //where(Category = filter("International Trade"));
            //This property is currently not supported
            //TestTableRelation = false;
            //
        }
