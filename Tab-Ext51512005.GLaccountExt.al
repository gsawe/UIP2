//************************************************************************
tableextension 51512005 "GLaccountExt" extends "G/L Account"
{
    fields
    {
        ...
        field(51512005; "Donor defined Account"; Boolean)
        {
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = '  ,InterestonLoanPortfolio,FeesCommissiononLoanPortfolio,GovernmentSecurities,InvestmentinCompaniesshares,nterestExpenseonDeposits,DividendExpenses,OtherFinancialExpense,FeesCommissionExpense,OtherExpense,ProvisionforLoanLosses,PersonnelExpenses,GovernanceExpenses,MarketingExpenses,DepreciationandAmortizationCharges,AdministrativeExpenses,Taxes,NonOperatingIncome,NonOperatingExpense,Donations,PlacementinBanks,CostofExternalBorrowings,EquityInvestmentsinsubsidiaries';
