...
Table 51512582 "Sacco Transfers Schedule"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = ' ,Plot Repayment,Deposit Contribution,Plot,Share Capital,Interest Paid';
            OptionMembers = " ","Plot Repayment","Deposit Contribution",Plot,"Share Capital","Interest Paid";

            ;
        }
        field(6; "Destination Loan"; Code[30])
        {
            TableRelation = if ("Destination Account Type" = filter(CUSTOMER)) "Loans Register"."Loan  No." where("BOSA No" = field("Destination Account No."))
            else
